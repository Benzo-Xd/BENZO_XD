...
def contact():
	...
	os.system('xdg-open https://www.facebook.com/profile.php?id=100050905935593')
...
╚═════╝░╚═════╝░╚═╝░░╚══╝╚══════╝░╚════╝░
➤➤⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃B3NZ0⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃➤➤
\033[1;32m ❣︎[𖣘]☔︎CREATED BY   :  B3NZ0_XD
\033[1;32m ❣︎[𖣘]☔︎ FB NAME     :  बेन्जो कलाकर
\033[1;32m ❣︎[𖣘]☔︎ON GITHUB    :  B3NZ0_XD
\033[1;32m ❣︎[𖣘]☔︎TOOL STATUS  :  FREE
\033[1;32m ❣︎[𖣘]☔︎TOOL VERSION :  1.0                           
➤➤⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃B3NZ0⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃➤➤  
\033[1;32m-fuwk3rrr  b3nz0 herrr'w - chitwooneyy !-""") 
def banner():
	print(logo)
		...
		with requests.Session() as r:
			...
			try:
				...
				if 'How do you want to log into Facebook?' in str(response2) or '/login/?next=' in str(response2):
					...
					action = ('action="(.*?)">', str(response2)).group(1).replace('amp;', '')
					...
					if 'https://m.facebook.com/dialog/oauth/?auth_type=rerequest&redirect_uri=' in str(response3.url):
						...
						if 'Success!' in str(response6):
							...
							animation(f'\033[0m \u001b[36m>>\033[1;37m LOGIN VAYO AABA RUN HANA');exit()
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r {P}[B3NZ0_XD]{P} {P}{loop}{P}/{P}{len(id)}{P} OK{P}[{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
